...
class FrogService {
   ...
   */
  method canMoveTo(pos) = stateManager.gameInProgress() && self.isWithinBounds(pos)
   ...
   */
  method isWithinBounds(pos) = self.isInsideHorizontalBounds(pos) && self.isInsideVerticalBounds(pos)
   ...
   */
  method isInsideHorizontalBounds(pos) = (pos.x() >= 0) && (pos.x() < game.width())
   ...
   */
  method isInsideVerticalBounds(pos) = (pos.y() >= 0) && (pos.y() < game.height())
}
